...
echo
for t in test_modules test_dist_cpseries test_dist_cpseries_socket test_dist_fader test_dist_sweep test_dist_flipflop test_dist_subharmonic test_stress; do
	echo "$t"
